...
class Grid:
    def __init__(self, frame_size_x, frame_size_y):
        ...
        self.score = 0  # Initialize score as 0
    ...
    def draw(self, game_window, snake_body, snake_direction):
        background = pygame.image.load("background.png")
        game_window.blit(background, (0,0))
        right_panel = pygame.image.load("right_panel.png")
        ...
        game_window.blit(score_text, (790,110))
        flag = 0
